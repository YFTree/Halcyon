...
- 本地音频标签主路径迁移到 lyrico-audiotag；Jaudiotagger 如仍保留，仅作为 legacy fallback，不再作为主路径。
...
| 音频元数据 | lyrico-audiotag 主路径、Jaudiotagger legacy fallback、读取内嵌和外置歌词、163 key 解密、alias / comment、显示音质标签 |
...
- **光锥音乐** — 界面设计与功能实现参考。
- 感谢 Ella Music 所使用的 Miuix、Media3、FFmpeg、Lyricon、SuperLyricApi、LyricGetter-API、Lyrico、TagLib、163KeyDecrypter、Backdrop、Coil、accompanist-lyrics-core 以及其它开源项目。
